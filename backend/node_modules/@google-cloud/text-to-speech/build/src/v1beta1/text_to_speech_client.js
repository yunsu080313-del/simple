...
class TextToSpeechClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('text-to-speech');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    initialize() {
        ...
        const textToSpeechStubMethods = ['listVoices', 'synthesizeSpeech', 'streamingSynthesize'];
    ...
    listVoices(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.listVoices(request, options, wrappedCallback)
    ...
    synthesizeSpeech(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.synthesizeSpeech(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('synthesizeSpeech response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
