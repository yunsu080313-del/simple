...
class SpeechClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('speech');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        if (opts.fallback) {
            ...
            lroOptions.httpRules = [{ selector: 'google.longrunning.Operations.GetOperation', get: '/v1/operations/{name=**}', }, { selector: 'google.longrunning.Operations.ListOperations', get: '/v1/operations', }];
        }
